        ...
        <div className="col">
          <table>
            <tbody>
              ...
              <tr>
                <td>UP</td>
                <td>PASS IN MODULE WHICH HAS NO GRADE POINT</td>
                <td className="text-center">NA</td>
              </tr>
              <tr>
                <td>UF</td>
                <td>FAIL IN MODULE WHICH HAS NO GRADE POINT</td>
                <td className="text-center">NA</td>
              </tr>
              <tr>
                <td>EX</td>
...
const renderEachModule = (p_objMod,iSn) => {
  return (
  <div className="row">
      <div className="col-1" style={{minWidth:'90px'}}> {p_objMod.name} </div>
...
const renderTermTranscript = (p_ObjTranscript,iSn) => {
  ...
  return (
  <div className="container mt-2" myLabel="semester result">
  {/*<div className="row">
    ...
    <div className="row mt-3">
      <div className="col-1" style={{minWidth:'90px'}} >Module Code</div>
