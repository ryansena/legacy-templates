...
const renderHeader = p_certificate => {
...
const renderTermTranscript = (p_ObjTranscript) => {
	...
	const xothItems = get(p_ObjTranscript, 'otherItems');
	const xoth = get(p_ObjTranscript, 'otherItems[0].name');
  return (
  <div className="row">
  <div className="col-10">
    ...
    <div className="row">
      ...
      <div className="col-2">{xothItems && `oth:${xoth}`}</div>
